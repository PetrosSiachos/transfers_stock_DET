		...
		for(;;) {
    		...
    		do {
    			...
    			if (y.equals("1")) {
    				...
    				Object [] possibleValues = { "PEN BLUE", "PEN RED", "PEN BLACK", "PEN GREEN",
    						"PEN PINK", "HIGHLIGHTER YELLOW", "HIGHLIGHTER PINK",
    						"HIGHLIGHTER GREEN", "SHARPENER", "RUBBER FOR PENCILS",  "RUBBER FOR PENS", 
    						"RULER BLACK",  "RULER WHITE", "PENCIL", "MECHANICAL PENCIL",
    						"RETRACTABLE LEAD", "COMPASSES", "PROTACTOR", "CORRECTOR PEN",
    						"MARKER YELLOW", "MARKER BLUE", "MARKER GREEN", "MARKER ORANGE",
    						"MARKER RED", "SCISSORS", "STAPLER", "INK CARTRIDGE", 
    						"CRAYON YELLOW", "CRAYON RED", "CRAYON BLUE", "CRAYON GREEN",
    				...
    				String Date = JOptionPane.showInputDialog(null, "Please insert the date in this format: YYYY/MM/DD");
    				try {
    					con = db.getConnection();
